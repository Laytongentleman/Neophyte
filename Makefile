...
# Project:  test.pro
# Template: app
# Command: /usr/lib64/qt5/bin/qmake -o Makefile test.pro
#############################################################################
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		custombutton.cpp moc_mainwindow.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h custombutton.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp custombutton.cpp $(DISTDIR)/
