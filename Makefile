...
neophyte: ui_mainwindow.h $(OBJECTS)  
...
compiler_moc_header_make_all: moc_custombutton.cpp moc_heatmap.cpp moc_heatmaptotal.cpp moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_custombutton.cpp moc_heatmap.cpp moc_heatmaptotal.cpp moc_mainwindow.cpp
